                ...
                restoredModalTypes.forEach(modalType => {
                    ...
                    switch (modalType) {
                        ...
                        case 'mastery':
                            ...
                            break;
                        case 'masteryTransform':
                            alertMessage += `\n• 精通转化: 固定值=${modalData.masteryTransformFixed || '0'}, 获取量=${modalData.masteryTransformAcquired || '0'}, Y系数=${modalData.masteryTransformY || '0'}`;
                            break;
                        case 'damageIncrease':
...
function createAppliedDataItem(modalType, data) {
    ...
    switch (modalType) {
        ...
        case 'masteryTransform':
            ...
            content.textContent = `固定值: ${data.masteryTransformFixed || '0'}, 获取量: ${data.masteryTransformAcquired || '0'}, Y系数: ${data.masteryTransformY || '0'}`;
            break;
        case 'damageIncrease':
